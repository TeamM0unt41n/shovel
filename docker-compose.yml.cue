import N "novara.m0unt41n.ch:networking"

#is_development: *true | bool @tag(is_development,type=bool)
...
services: {
	...
	webapp: {
		...
		labels: [
			...
			"traefik.http.routers.shovel.rule=Host(`\(N.domains.public)`) && PathPrefix(`/shovel/`)",
